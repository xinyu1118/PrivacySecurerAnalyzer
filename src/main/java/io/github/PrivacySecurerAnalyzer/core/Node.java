...
public class Node {
    ...
    // PrivacyStreams DFG
    public static final String TYPE_PS_FUNCTION = "PS_FUNCTION";
    public static final String TYPE_PS_CONST = "PS_CONST";
    public static final String TYPE_PS_UNKNOWN = "PS_UNKNOWN";
