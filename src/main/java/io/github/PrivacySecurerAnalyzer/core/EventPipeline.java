...
public class EventPipeline extends PSFunction {
    protected List<Object> nextPipelines;

    public EventPipeline(InvokeExpr invokeExpr, Unit hostUnit, SootMethod hostMethod, Body hostBody, LocalDefs localDefs, LocalUses localUses) {
